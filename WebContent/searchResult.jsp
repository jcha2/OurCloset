...
<%
	try {
		...
		String category = request.getParameter("searchCate");

		ResultSet rs = DBUtil.searchPosting(conn, search, category);
%>
<body>
	<div align="center">
		<h2>
	...
	<div align="right" style="border: 2px solid #FFB2D9; height: 5%;">
		<%
	...
	<div style="padding: .5%; background-color: #FFB2D9; height: 10%">
			...
			<tr style="background: lightgray;">
				...
				<td>
					<%
						if (session.getAttribute("emailid") != null) {
									if (!emailid.equals(rs.getString(7))) {
										String sendere = (String) session.getAttribute("emailid");
					...
					<form method="post" action="sendFirstRequest"
						...
						<input type="hidden" name="from" value="<%=sendern%>"> <input
							type="hidden" name="to" value="<%=rs.getString(2)%>"> <input
